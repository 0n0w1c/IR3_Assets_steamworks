data:extend({
    {
        ...
        crafting_categories = { "steam-unbarrelling" },
        crafting_speed = 0.75,
        ...
        dying_explosion = "steam-unbarrelling-machine-explosion",
        ...
        minable = {
            mining_time = 0.2,
            result = "steam-unbarrelling-machine"
        },

        mined_sound = { filename = "__core__/sound/deconstruct-medium.ogg" },

        placeable_by = { item = "steam-unbarrelling-machine", count = 1 },
