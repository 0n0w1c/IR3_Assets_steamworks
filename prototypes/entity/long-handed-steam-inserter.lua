data:extend({
    {
        ...
        dying_explosion = "long-handed-steam-inserter-explosion",
        ...
        hand_base_picture = {
            filename = "__IndustrialRevolution3Assets2__/graphics/entities/inserters/hr-orange-inserter-hand-base.png",
            height = 136,
            priority = "extra-high",
            scale = 0.25,
            width = 32
        ...
        hand_closed_picture = {
            filename = "__IndustrialRevolution3Assets2__/graphics/entities/inserters/hr-orange-inserter-hand-closed.png",
            height = 164,
            priority = "extra-high",
            scale = 0.25,
            width = 72
        ...
        hand_open_picture = {
            filename = "__IndustrialRevolution3Assets2__/graphics/entities/inserters/hr-orange-inserter-hand-open.png",
            height = 164,
            priority = "extra-high",
            scale = 0.25,
            width = 72
        ...
        max_health = 100,
        minable = { mining_time = 0.1, result = "long-handed-steam-inserter" },
        open_sound = {
            {
