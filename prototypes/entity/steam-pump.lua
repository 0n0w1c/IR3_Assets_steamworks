...
entity.animations                                = {
    north = {
        layers = {
            {
                filename = "__IndustrialRevolution3Assets2__/graphics/entities/pipes/valve-steam-n.png",
                priority = "extra-high",
                width = 180,
                height = 120,
                frame_count = 1,
    ...
    east = {
        layers = {
            {
                filename = "__IndustrialRevolution3Assets2__/graphics/entities/pipes/valve-steam-e.png",
                priority = "extra-high",
                width = 180,
                height = 120,
                frame_count = 1,
    ...
    south = {
        layers = {
            {
                filename = "__IndustrialRevolution3Assets2__/graphics/entities/pipes/valve-steam-s.png",
                priority = "extra-high",
                width = 180,
                height = 120,
                frame_count = 1,
    ...
    west = {
        layers = {
            {
                filename = "__IndustrialRevolution3Assets2__/graphics/entities/pipes/valve-steam-w.png",
                priority = "extra-high",
                width = 180,
                height = 120,
                frame_count = 1,
